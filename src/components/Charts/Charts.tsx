  ...
  return (
    <>
      <div className="flex flex-row gap-5 min-w-full max-w-max">
        ...
        <div className="p-5 xl:basis-2/6 2xl:basis-1/5 min-w-max border-solid border-2 border-[#00B7C2] bg-[#0B4D76]/50 rounded-md backdrop-blur-sm">
          <div className="flex flex-col items-center justify-center w-full h-full">
            <div className="bg-[#185e86]/30 w-full p-5 rounded-md">
              <p className="text-lg font-Roboto text-center">USDT/PE</p>
              <p className="text-center text-6xl">240</p>
            </div>
            <div className="w-full h-[1px] my-2 bg-[#82ca9d]"></div>
            <div className="bg-[#185e86]/30 w-full p-5 rounded-md">
      ...
      <div className="flex flex-row gap-5 min-w-full flex-nowrap flex-grow-0-1 max-h-[20rem]">
        <div className="p-5 xl:basis-[15%] 2xl:basis-[20%] w-full border-solid border-2 border-[#00B7C2] bg-[#0B4D76]/50 backdrop-blur-sm rounded-md h-full min-h-[20em]">
            <div className="flex flex-col h-full w-full items-center justify-center align-middle">
              <div className="flex flex-row w-full justify-between">
                  ...
                  <span className="text-lg font-Roboto rounded-full bg-[#00B7C2] w-7 h-7 text-center">?</span>
              </div>
              ...
              <div className="mt-auto h-full relative">
                <p className="absolute left-16 top-0 font-Roboto">0%</p>
                <p className="absolute right-16 top-0 font-Roboto">+5%</p>
        ...
        <div className="p-5 xl:basis-[37.6%] 2xl:basis-2/5 border-solid border-2 border-[#00B7C2] bg-[#0B4D76]/50 backdrop-blur-sm rounded-md xl:min-h-[20rem] 2xl:min-h-[25rem] xl:max-w-[80%] flex flex-col">
          <div className="flex flex-row w-full justify-center">
            ...
            <span className="text-lg font-Roboto rounded-full bg-[#00B7C2] w-7 h-7 text-center ml-auto">?</span>
          </div>
          <ResponsiveContainer className="xl:h-[15rem] 2xl:h-[20rem] w-full">
            <AreaChart
              width={300}
        ...
        <div className="p-3 xl:basis-2/6 2xl:basis-2/5 min-w-max border-solid border-2 border-[#00B7C2] bg-[#0B4D76]/50 rounded-md backdrop-blur-sm ">
          <p className="2xl:hidden font-Roboto text-2xl text-center h-fit">Bóveda</p>
          <div className="flex 2xl:flex-row xl:flex-col justify-center w-full">
            <div className="xl:hidden flex flex-col w-full justify-center items-center">
              <p>Bóveda</p>
              <Image src="./public/boveda.svg" alt="Ilustración de bóveda" width={100} height={100}/>
            </div>
            <div className="flex flex-col gap-2 py-2 px-5 w-full h-fit">
              <div className="flex flex-col w-full">
                <p className=" font-Roboto text-md">Respaldo en USDT</p>
                <div className="border-2 border-solid border-[#00B7C2] bg-[#0D0D0D]/50 rounded-md p-2 w-full">
                  <p className="text-center font-Roboto xl:text-2xl 2xl:text-3xl">10.000</p>
                </div>
              </div>
              <div className="flex flex-col w-full">
                <p className=" font-Roboto text-md">Respaldo en USDT</p>
